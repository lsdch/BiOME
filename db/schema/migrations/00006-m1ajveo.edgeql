CREATE MIGRATION m1ajveok2zuqc33n4oqn34imu5bdvb737sbz3t5t2cgsm7uzgu32tq
    ONTO m1xs5v4zu7mg5woszun3ds53ti7scatdkdpgja54ea47zx5u5on34q
{
  ...
  ALTER FUNCTION occurrence::insert_internal_biomat(sampling: events::Sampling, data: std::json) USING (WITH
      identification := 
          (data)['identification']
      ,
      taxon := 
