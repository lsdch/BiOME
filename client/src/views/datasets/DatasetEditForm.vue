...
import { $SiteDatasetUpdate, LocationService, SiteDataset, SiteDatasetUpdate } from '@/api'
...
async function submit() {
  ...
  await LocationService.updateSiteDataset({ path: { slug: dataset.value.slug }, body })
    .then(errorHandler)
    .then((updated) => {
