      ...
      <v-card v-if="format == 'CSV'" class="bg-main mb-5 rounded-t-0">
        <v-card-text>
          ...
          <div class="d-flex ga-5">
            <v-checkbox label="Force quotes" v-model="optionsCSV.quotes"></v-checkbox>
...
import CSVDelimiterPicker from '../toolkit/ui/exports/CSVDelimiterPicker.vue'
import { DateTime } from 'luxon'
import { useToggle, useWebWorkerFn } from '@vueuse/core'
import CSVQuotePicker from '../toolkit/ui/exports/CSVQuotePicker.vue'
