  ...
  <v-card v-bind="$attrs">
    ...
    <v-expand-transition>
      <div v-show="expanded" class="">
        <v-divider />
        <DataFeedFilters v-model="feed.filters" class="pa-2" />
...
import DataFeedFilters from './DataFeedFilters.vue'
import { DataFeed, useDataFeeds } from '.'
import { useQuery } from '@tanstack/vue-query'
import { occurrencesBySiteOptions } from '@/api/gen/@tanstack/vue-query.gen'
import MapStatsDialog from '@/features/occurrences/components/OccurrencesStatsDialog.vue'
