...
export class LocationService {
     ...
     */
    public static updateSiteDataset(options: Options<UpdateSiteDatasetData>) {
        return (options?.client ?? client).patch<UpdateSiteDatasetResponse, UpdateSiteDatasetError>({
            ...options,
            url: '/datasets/{slug}'
        });
    }
     ...
     */
    public static getSiteDataset(options: Options<GetSiteDatasetData>) {
        return (options?.client ?? client).post<GetSiteDatasetResponse, GetSiteDatasetError>({
            ...options,
            url: '/datasets/{slug}'
        });
    }
     ...
     */
    public static updateSite(options: Options<UpdateSiteData>) {
        return (options?.client ?? client).patch<UpdateSiteResponse, UpdateSiteError>({
            ...options,
            url: '/sites/{code}'
        });
    }
...
export class AccountService {
     ...
     */
    public static listPendingUserRequests(options?: Options<ListPendingUserRequestsData>) {
        return (options?.client ?? client).get<ListPendingUserRequestsResponse, ListPendingUserRequestsError>({
            ...options,
            url: '/account/pending'
        });
    }
     ...
     * Get account requests pending validation using the associated email
     */
    public static getPendingUserRequest(options?: Options<GetPendingUserRequestData>) {
        return (options?.client ?? client).get<GetPendingUserRequestResponse, GetPendingUserRequestError>({
            ...options,
