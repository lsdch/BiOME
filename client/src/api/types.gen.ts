...
export type CoordinatePrecision = 'm10' | 'm100' | 'Km1' | 'Km10' | 'Km100' | 'Unknown'
...
export type SiteItem = {
  altitude?: SiteItemAltitudeStruct
  code: string
...
export type SiteItemAltitudeStruct = {
  max?: number
  min: number
}
