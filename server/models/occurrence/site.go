...
type SiteItem struct {
	...
	LastVisited         OptionalDateWithPrecision         `gel:"last_visited" json:"last_visited,omitzero" doc:"Last visit date with precision. If not set, site has never been visited."`
}
