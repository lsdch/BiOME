...
type SiteInput struct {
	...
	UserDefinedLocality bool                         `gel:"user_defined_locality" json:"user_defined_locality" doc:"Signals if locality was manually entered by user, and automatically inferred from coordinates"`
