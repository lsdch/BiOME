...
type SecuritySettingsInput struct {
	...
	AuthTokenLifetimeMinutes  int32  `edgedb:"auth_token_lifetime" json:"auth_token_lifetime" doc:"User session lifetime in minutes" minimum:"15" fake:"{number:15,1000}"`
