...
// 	Spec     string `json:"spec" doc:"A JSON representation of settings."`
// 	IsGlobal bool   `json:"is_global" doc:"Global settings are considered as part of the application."`
// 	IsPublic bool   `json:"is_public" doc:"Public settings are available to all users, while private settings are only available to the user who created them."`
// }

// type PresetsInput struct {
// 	ID models.Optional[uuid.UUID] `json:"id,omitzero"`
// 	PresetsInner
...
// type Presets struct {
// 	ID          uuid.UUID               `edgedb:"id" json:"id" format:"uuid"`
// 	Description models.Optional[string] `json:"description,omitempty"`
// 	PresetsInput
// }
