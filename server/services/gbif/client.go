...
type SearchResponse struct {
	...
	Results      []models.TaxonGBIF `json:"results"`
}

func (resp SearchResponse) GetExactMatch(name string) (*models.TaxonGBIF, bool) {
	matches := []models.TaxonGBIF{}
...
func (resp SearchResponse) GetFirstResult() (*models.TaxonGBIF, error) {
...
func (c *GBIFClient) GetTaxonByKey(ctx context.Context, usageKey int32) (*models.TaxonGBIF, error) {

	path := "/v1/species/" + strconv.FormatInt(int64(usageKey), 10)

	var result models.TaxonGBIF
