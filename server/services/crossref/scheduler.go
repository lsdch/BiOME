...
// func NewScheduler(cfg config.Config) *CrossRefScheduler {
...
// // BibliographicSearch queries the CrossRef API for works matching a given bibliographic string.
// // The function enqueues the request to the CrossRef client queue and waits for the response.
// // It returns a BibSearchResults struct containing the total number of results and a slice of matching items.
